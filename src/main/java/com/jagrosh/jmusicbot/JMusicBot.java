...
public class JMusicBot 
{
    ...
    public static void main(String[] args)
    {
        ...
        AboutCommand aboutCommand = new AboutCommand(Color.BLUE.brighter(),
                                "GSTLA Additional and right handed music player for SRT related Groups only, Currently managed by RobloxstudiowikiGST")",
                                new String[]{"High-quality music playback", "No Premium", "Easy to Use"},
                                RECOMMENDED_PERMS);
